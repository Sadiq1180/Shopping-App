...
class ApiServices extends DioCore {
  ...
  Future<Response> postFormData(String path,
    ...
    return await dio.post(path,
        data: formData, options: _options(enableLocalPersistence,contentTypeHeader: Headers.multipartFormDataContentType));
  }
  ...
  Options _options(bool enableLocalPersistence,{String contentTypeHeader=Headers.jsonContentType}) =>
