...
import 'package:shopping_app/shared/constants/app_textstyle.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(Icons.dark_mode, color: context.theme.iconTheme.color),
          ),
          IconButton(
            onPressed: () => localizationPro.setLanguage(0),
          ...
          IconButton(
            ...
            icon: Icon(Icons.download, color: context.theme.iconTheme.color),
          ),
        ],
      ),
      body: Column(
        children: [
          ...
          Expanded(
            child: Consumer(
              builder: (context, ref, child) {
                var airRes = ref.watch(
                  dummyProvider.select((value) => value.airlineRes),
                );
                return BaseWidget(
                  state: airRes!,
                  onReload: () => dummyPro.getAir(),
                  builder: (context) {
